...
system("java -jar $gatk_dir/GenomeAnalysisTK.jar -T DepthOfCoverage -I $bam -o $outdir/$prefix.dep -L $bed -R $ref -omitBaseOutput -omitLocusTable  --summaryCoverageThreshold 20  -rf BadCigar");   ### 20160510 change to 20 20160615 -rf BadCigar
