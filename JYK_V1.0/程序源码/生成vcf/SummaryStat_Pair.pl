...
system("java -jar $gatk_dir/GenomeAnalysisTK.jar -T DepthOfCoverage -I $bam -o $outdir/$prefix.dep -L $bed -R $ref -omitBaseOutput -omitLocusTable -rf BadCigar --summaryCoverageThreshold 20");
