...
system ("date");
system ("perl /share/nas1/sunqh//product/ys/report/program/ys_merge_information.pl -i1 $I1 -i2 $I2");

system ("date");
system ("perl /share/nas1/sunqh//product/ys/report/program/get_var.pl -i information");             

system ("date");
system ("perl /share/nas1/sunqh//product/ys/report/program/print.pl -i var -o $O");                             

system ("date");
#system ("mv information var /home/sunqh//product/ys/report/file/");  
