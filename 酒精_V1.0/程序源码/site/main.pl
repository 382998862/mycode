...
if (!defined($opts{i}))
{
         ...
         Description:
             ...
             -i                  3F/4F abi file dir                                 must be given
...
system("Rscript /share/nas1/sunqh//product/jj/site/sangerseq.R $I ") ;
system("perl /share/nas1/sunqh//product/jj/site/cut.pl -f $I -o $I");
system("perl /share/nas1/sunqh//product/jj/site/rehebin.pl -r /share/nas1/sunqh//product/jj/site/jj.fa -c $I -cr a -s b");
system("perl /share/nas1/sunqh//product/jj/site/cor.pl");
system("Rscript /share/nas1/sunqh//product/jj/site/sort.R $I ");
